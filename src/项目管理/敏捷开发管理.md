...
- 结对编程：两名程序员在一台计算机上共同工作，一人输入代码，一人进行审查，结对编程有利于培养T型人才

- 敏捷常用方法：约定完成的定义（DOD），持续集成，频繁的相关方参与和反馈

  技术债务指没有做好本该做好的工作，对后续产生影响，采用重构解决
  
- SOS会议：多个小敏捷团队共同工作，每个团队站会后，各派一代表进行的会议

- 敏捷团队中的基本规则，可以制定团队工作协议，如会议迟到问题
...
- 项目愿景
  - 项目章程，项目目标
- 路线图
  - 版本数量，每个版本内容（每个版本是一个项目）
- 发布计划
  - 通过多少个迭代实现版本，不涉及具体的详细活动
- 迭代规划会议
- 每日站会
- 迭代评审会议
- 迭代回顾会议
...
- 五个事件：Sprint、Sprint规划会议、每日Scrum站会、Sprint评审会议、Sprint回顾会议
