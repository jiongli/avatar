## **输出MySQL数据结构为Markdown文件**

![1](assets/输出MySQL数据结构为Markdown文件/数据结构.jpg)

```python
from sqlalchemy import create_engine
from urllib.parse import quote_plus

conn_str = 'mysql+pymysql://root:%s@10.0.43.108:3306/information_schema?charset=utf8' % quote_plus('Unidata108.')
