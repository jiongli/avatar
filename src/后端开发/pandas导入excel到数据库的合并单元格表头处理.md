## **pandas导入excel到数据库的合并单元格表头处理**

- 待入库数据

![](assets/pandas导入excel到数据库的合并单元格表头处理/库存数据.jpg)
...
conn_str = 'mysql+pymysql://root:%s@10.0.43.108:3306/ym_log_new?charset=utf8' % quote_plus('********')
