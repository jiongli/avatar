...
input[type="submit"]:hover {/* 鼠标悬停变化 */
    ...
    padding: 8.5px 14.5px;/* 填充 */
    margin: 0px 1.5px;/* 元素边距 */
}
label{
    font-size: 14px;/* 字体大小 */
    color: #606266;/* 字体颜色 */
    padding: 0 1px 0 0px;/* 填充 */
}
input[type="text"]{
    height: 28px;/* 高度 */
    color: #606266;/* 字体颜色 */
...
textarea{
    ...
    border: 1px solid #DCDFE6;/* 边框属性 */
    border-radius: 3px;/* 圆角 */
    margin: 5px 3px -14px 3px;/* 元素边距 */
}
input[type="text"]:focus,textarea:focus {
    outline: 1px solid #409EFF;/* 点击后边框属性 */
}
```
